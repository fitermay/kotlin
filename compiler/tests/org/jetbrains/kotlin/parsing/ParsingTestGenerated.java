...
public class ParsingTestGenerated extends AbstractParsingTest {
    ...
    public static class Psi extends AbstractParsingTest {
        ...
        public static class Recovery extends AbstractParsingTest {
            ...
            @TestMetadata("lambdaExpressionInString_3.kt")
            public void testLambdaExpressionInString_3() throws Exception {
                String fileName = KotlinTestUtils.navigationMetadata("compiler/testData/psi/recovery/lambdaExpressionInString_3.kt");
                doParsingTest(fileName);
            }
