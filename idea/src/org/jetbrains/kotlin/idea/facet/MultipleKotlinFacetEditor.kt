    ...
    override fun createComponent(): JComponent? {
        return KotlinFacetEditorGeneralTab.EditorComponent(project, null).apply {
            ...
            with(compilerConfigurable) {
                ...
                helper.bind(outputPrefixFile, editors) { it.compilerConfigurable.outputPrefixFile}
                helper.bind(outputPostfixFile, editors) { it.compilerConfigurable.outputPostfixFile}
